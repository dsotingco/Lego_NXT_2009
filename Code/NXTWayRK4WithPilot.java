...
public class NXTWayRK4WithPilot implements TimerListener
{
	public static int tiltAngle = 0; //degrees
	public static GyroSensor theGyro = new GyroSensor(SensorPort.S3);
	public static int theDelay = 20;  //in milliseconds
	public static int t = 0; //initialize time
	public static Timer timer = new Timer(theDelay,new NXTWayRK4WithPilot()); //this line needs to be changed if the name of this file changes (e.g. with saved copies)
	public static int[] speeds = new int[3];
	public static Pilot pilot = new Pilot(2.25f, 2.75f, Motor.B,Motor.C);
	...
	public void timedOut()
	{
		...
		int k = 1; //units of cm/deg
		float motorInput = k*newAngle;
		pilot.travel(motorInput);
